...
export const getResultsFirstActivity = async () => {
	...
	let allCorrectResults =
		parseInt(firstActivityCorrect !== null ? firstActivityCorrect : 0) + parseInt(secondActivityCorrect !== null ? secondActivityCorrect : 0);
	let allIncorrectResults =
		parseInt(firstActivityIncorrect !== null ? firstActivityIncorrect : 0) + parseInt(secondActivityIncorrect !== null ? secondActivityIncorrect : 0);
...
export const getResultsSecondActivity = async () => {
	...
	let allCorrectResults =
		...
		parseInt(thirdActivityCorrect !== null ? thirdActivityCorrect : 0);
	...
	let allIncorrectResults =
		...
		parseInt(thirdActivityIncorrect !== null ? thirdActivityIncorrect : 0);
