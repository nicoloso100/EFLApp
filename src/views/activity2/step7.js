...
const Step7 = ({ navigation }) => {
  ...
  const onRefresh = useCallback(() => {
    ...
    wait(200).then(async () => {
      ...
      const thirdActivityCorrect = detailed.thirdActivityCorrect;
      const thirdActivityIncorrect = detailed.thirdActivityIncorrect;
      ...
      setAllResults([
        ...
        {
          id : 3,
          correct: thirdActivityCorrect ? thirdActivityCorrect : '0',
          incorrect: thirdActivityIncorrect ? thirdActivityIncorrect : '0'
        }
      ]);
      setRefreshing(false);
    });
      ...
      Alert.alert(
        ...
        [
          ...
          {text: `D'accord`, onPress: async () => {
            await AsyncStorage.removeItem('SecondActivityFirstStepCorrect');
            await AsyncStorage.removeItem('SecondActivityFirstStepIncorrect');
            await AsyncStorage.removeItem('SecondActivitySecondStepCorrect');
            await AsyncStorage.removeItem('SecondActivitySecondStepIncorrect');
            await AsyncStorage.removeItem('SecondActivityThirdStepCorrect');
            await AsyncStorage.removeItem('SecondActivityThirdStepIncorrect');
