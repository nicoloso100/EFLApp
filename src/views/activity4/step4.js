			...
			Alert.alert(
				...
				[
					...
					},
					{
						text: `D'accord`,
						onPress: async () => {
							await AsyncStorage.removeItem("FourthActivityFirstStepCorrect");
							await AsyncStorage.removeItem("FourthActivityFirstStepIncorrect");
							await AsyncStorage.removeItem("FourthActivitySecondStepCorrect");
							await AsyncStorage.removeItem("FourthActivitySecondStepIncorrect");
							onRefresh();
						}
					}
				],
