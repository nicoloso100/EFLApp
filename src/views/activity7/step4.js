      ...
      Alert.alert(
        ...
        [
          ...
          {text: `D'accord`, onPress: async () => {
            await AsyncStorage.removeItem('SeventhActivityFirstStepCorrect');
            await AsyncStorage.removeItem('SeventhActivityFirstStepIncorrect');
            await AsyncStorage.removeItem('SeventhActivitySecondStepCorrect');
            await AsyncStorage.removeItem('SeventhActivitySecondStepIncorrect');
          }},
        ],
        {cancelable: false},
      );
